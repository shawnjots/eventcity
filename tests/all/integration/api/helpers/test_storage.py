...
class TestStorage(OpenEventTestCase):
    ...
    @patch('app.api.helpers.storage.get_settings', return_value={'static_domain': 'https://next.theeventcity.com'})
    ...
    def test_upload_local(self, uploadedfile_object, settings, generated_hash, uploadlocal):
        expected_response = 'https://next.theeventcity.com/static/media/upload_key/hash/test.pdf'
