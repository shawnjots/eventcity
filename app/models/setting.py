...
class Setting(db.Model):
    ...
    frontend_url = db.Column(db.String, default="http://theeventcity.com")
    ...
    cookie_policy_link = db.Column(db.String, default="https://next.theeventcity.com/cookie-policy")
