...
Swagger API documentation with live-testing feature is available at `/api/v1` endpoint of the server where Events City is hosted.
...
are down/dead, please refer to it. It will always contain docs of latest version of Events City Orga Server.
